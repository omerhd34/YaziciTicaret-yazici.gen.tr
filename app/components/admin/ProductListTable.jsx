    ...
    <div className="flex flex-wrap gap-4 items-end">
     ...
     {(selectedCategory || selectedSubCategory || selectedStockFilter) && (
      <button
       ...
       className="px-6 py-3 bg-linear-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-xl font-bold shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105 active:scale-95 flex items-center gap-2"
      >
