...
export default function Error({ reset }) {
 return (
  <>
   <Header />
   <main id="main-content" className="min-h-screen flex-1 bg-linear-to-br from-gray-50 via-red-50/30 to-gray-50 flex items-start justify-center px-4 pt-16 pb-8">
