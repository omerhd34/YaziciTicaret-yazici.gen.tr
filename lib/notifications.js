...
export const sendUserOrderConfirmationEmail = async ({
 ...
 try {
  ...
  if (!transporter) {
   console.error('E-posta ayarları eksik. Müşteri sipariş onay maili gönderilemedi.');
   return { success: false, error: 'E-posta ayarları eksik' };
  }
  ...
  console.error('Müşteri sipariş onay maili hatası:', error);
  return { success: false, error: error.message || String(error) };
 }
};
...
export const sendUserOrderStatusUpdateEmail = async ({
 ...
 try {
  ...
  if (!transporter) {
   console.error('E-posta ayarları eksik. Müşteri sipariş durumu güncelleme maili gönderilemedi.');
   return { success: false, error: 'E-posta ayarları eksik' };
  }
  ...
  console.error('Müşteri sipariş durumu güncelleme maili hatası:', error);
  return { success: false, error: error.message || String(error) };
 }
};
...
export const sendAdminOrderCancelledEmail = async ({
 ...
 try {
  const transporter = createTransporter();
  if (!transporter) {
   console.error('E-posta ayarları eksik. Sipariş iptal bildirimi gönderilemedi.');
   return { success: false, error: 'E-posta ayarları eksik' };
  }
  ...
  console.error('Admin sipariş iptal bildirimi e-posta hatası:', error);
  return { success: false, error: error.message || String(error) };
 }
};
...
export const sendUserReturnRejectedEmail = async ({
 ...
 try {
  const transporter = createTransporter();
  if (!transporter) {
   console.error("E-posta ayarları eksik. Müşteri iade reddi gönderilemedi.");
   return { success: false, error: "E-posta ayarları eksik" };
  }
  ...
  console.error("sendUserReturnRejectedEmail error:", error);
  return { success: false, error: error.message || String(error) };
 }
};
